...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var s = x3.name$2;
      var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(s, references);
      var temp$references = $as_sci_Map(references.$$minus__O__sc_Map(s));
      expr = temp$expr;
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      if (($uD(delta$1.apply__O()) < 0)) {
        ...
        var jsx$1 = $uD(a$2.apply__O());
        var x$1 = $uD(delta$1.apply__O());
        var array = [((jsx$3 - jsx$2) / (2 * jsx$1)), (((-$uD($g["Math"]["sqrt"](x$1))) - $uD(b$2.apply__O())) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Signal = (function(x) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, x$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(x$1.apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, x));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
